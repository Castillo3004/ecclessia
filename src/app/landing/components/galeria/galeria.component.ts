...
import { GaleriaEventosService } from '../../services/galeria-eventos.service';
...
export class GaleriaComponent implements OnInit{
  ...
  ngOnInit(): void {
    this.traerGaleriaEventos();
  }

  private readonly galeriaEventosService = inject( GaleriaEventosService );


  public galeriaEventos: GaleriaEventos[] = [];


  traerGaleriaEventos(){
    this.galeriaEventosService.getGaleriaAeventos().subscribe( galeriaEventos => {
